...
import mainLevelGenrePage from './mainLevelGenrePage';
...
const mainlevelArtistPage = getElementFromTemplate(markupString);
const answerAreaList = [...mainlevelArtistPage.querySelectorAll(`.main-answer-wrapper`)];
answerAreaList.forEach((answerArea) => {
  answerArea.addEventListener(`click`, () => {
    renderPage(mainLevelGenrePage);
  });
});
